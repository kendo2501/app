...
import { getFinalH8Value } from '../../untils/mandalaCalculations';
...
export default function H8({ onBack }: Props) {
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            try {
                ...
                const { dd, yyyy } = JSON.parse(userData);
                const result = getFinalH8Value(dd, yyyy);
                ...
                if (result !== null) {
                    ...
                    setError('Dữ liệu ngày hoặc năm không hợp lệ.');
        ...
        <ImageBackground source={BACKGROUND_IMAGE} style={styles.background} resizeMode="cover">
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>H8</Text>
                </View>
