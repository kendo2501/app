...
import { getFinalH10Value } from '../../untils/mandalaCalculations';
...
export default function H10({ onBack }: Props) {
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            try {
                ...
                const { dd, mm, yyyy } = JSON.parse(stored);
                const result = getFinalH10Value(dd, mm, yyyy);
                ...
                if (result !== null) {
                    ...
                    setError('Không thể tính H10 vì thiếu dữ liệu hoặc dữ liệu không hợp lệ.');
        ...
        <ImageBackground source={BACKGROUND_IMAGE} style={styles.background} resizeMode="cover">
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>H10</Text>
                </View>
