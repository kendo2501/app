...
import { getFinalH12Value } from '../../untils/mandalaCalculations';
...
export default function H12({ onBack }: Props) {
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            try {
                ...
                const result = getFinalH12Value(dd, mm, yyyy);
                ...
                if (result !== null) {
                    ...
                    setError('Không thể tính H12 do dữ liệu không hợp lệ.');
        ...
        <ImageBackground source={BACKGROUND_IMAGE} style={styles.background} resizeMode="cover">
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>H12</Text>
                </View>
