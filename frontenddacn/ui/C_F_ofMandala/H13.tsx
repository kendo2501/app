...
import { getFinalH13Value } from '../../untils/mandalaCalculations';
...
export default function H13({ onBack }: Props) {
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            try {
                ...
                const result = getFinalH13Value(dd, mm, yyyy);
                ...
                if (result !== null) {
                    ...
                    setError('Không thể tính H13 do dữ liệu không hợp lệ.');
        ...
        <ImageBackground source={BACKGROUND_IMAGE} style={styles.background} resizeMode="cover">
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>H13</Text>
                </View>
