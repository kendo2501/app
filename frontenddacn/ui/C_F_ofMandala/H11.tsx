...
import { getFinalH11Value } from '../../untils/mandalaCalculations';
...
export default function H11({ onBack }: Props) {
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            try {
                ...
                const result = getFinalH11Value(dd, mm, yyyy);
                ...
                if (result !== null) {
                    ...
                    setError('Không thể tính H11 do dữ liệu không hợp lệ.');
        ...
        <ImageBackground source={BACKGROUND_IMAGE} style={styles.background} resizeMode="cover">
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>H11</Text>
                </View>
