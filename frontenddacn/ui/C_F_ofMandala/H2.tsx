            ...
            try {
                ...
                if (storedUserInfo) {
                    ...
                    if (calculatedH2 !== null) {
                        const description = await searchMandalaInfoByNumber(calculatedH2);
                        setMandalaDescription(description?.trim() || `Không tìm thấy mô tả cho số ${calculatedH2}.`);
                    } else {
                        setMandalaDescription("Tháng sinh không hợp lệ.");
                    }
                } else {
